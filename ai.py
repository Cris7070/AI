...
BUTTONS = {
    "A*": pygame.Rect(10, WIDTH + 10, 80, 30),
    "DFS": pygame.Rect(100, WIDTH + 10, 80, 30),
    "BFS": pygame.Rect(190, WIDTH + 10, 80, 30),
    "UCS": pygame.Rect(280, WIDTH + 10, 80, 30),
    "Dijkstra": pygame.Rect(370, WIDTH + 10, 100, 30),
    "Clear": pygame.Rect(480, WIDTH + 10, 80, 30),
}
